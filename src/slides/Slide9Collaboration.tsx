...
export default function Slide9Collaboration({ direction }: { direction: number }) {
  ...
  return (
    <div className={`w-full min-h-screen md:min-h-full flex items-center justify-center gradient-bg-3 transition-all duration-700 ${
      visible ? 'opacity-100' : 'opacity-0'
    }`}>
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 w-full py-8 md:py-12 lg:py-16">
        <h2 className={`font-bold tracking-[0.1em] sm:tracking-[0.15em] md:tracking-[0.2em] text-white mb-6 md:mb-12 lg:mb-16 transition-all duration-700 delay-200 ${
